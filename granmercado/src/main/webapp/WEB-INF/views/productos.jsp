		...
		<div class="container" id="font01">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav ">
					...
					<li><a href="<c:url value="/productos" />"><span
							style="color: rgba(255, 237, 0, 1.00);">Pizarra de<br>Productos
						</span></a></li>
		...
		<div class="">
			<div class="container sPad">
				<div class="col-md-12 sPad">
					<!--<figure class="sMar">-->
					<div class="item">
						<img src="${Img}/pizarra.jpg" alt="" class="img-responsive">
					</div>
					<!--</figure>-->
					<!--
                    <div class="bgTitle margLef">
                        <h2 class="pad">PIZARRA DE<br>PRODUCTOS</h2>
                    </div>  -->
				</div>
			...
			<div class="contCuerpo">
				...
				<div class="col-md-4 contWhite sPad">
					<div class="col-md-12">
						...
						<p>Este condimento saborizante, tan difundido en toda América
							y tan bien recibido en toda Europa desde principios de la
							transculturización. El ají, cuando se consume en concentraciones
							adecuadas produce una sensación urente muy estimulante del
							apetito,</p>
					...
					<div class="col-md-12">
						<figure class="sMar">
							...
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_chirimoya_01.jpg" /></a>
						</figure>
				...
				<div class="col-md-4 contWhite sPad">
					<div class="col-md-12">
						<figure class="sMar">
							<br>
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_lucuma_01.jpg" /></a>
						</figure>
				...
				<div class="col-md-4 contGray sPad">
					<div class="col-md-12">
						<figure class="sMar">
							<br>
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_olluco_01.jpg" /></a>
						</figure>
				...
				<div class="col-md-4 contWhite sPad">
					<div class="col-md-12">
						<figure class="sMar">
							<br>
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_papa_nativa_01.jpg" /></a>
						</figure>
				...
				<div class="col-md-4 contGray sPad">
					<div class="col-md-12">
						<figure class="sMar">
							<br>
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_pina_01.jpg" /></a>
						</figure>
				...
				<div class="col-md-4 contWhite sPad">
					<div class="col-md-12">
						<figure class="sMar">
							<br>
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_quinua_01.jpg" /></a>
						</figure>
				...
				<div class="col-md-4 contGray sPad">
					...
					<div class="col-md-12">
						<figure class="sMar">
							<br>
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_tomate_01.jpg" /></a>
						</figure>
				...
				<div class="col-md-4 contWhite sPad">
					<div class="col-md-12">
						<figure class="sMar">
							<br>
							<a href="#"><img class="img-responsive"
								src="${Img}/producto_pallar_01.jpg" /></a>
						</figure>
						<h2 class="font06">Pallares</h2>
						<p>Este condimento saborizante, tan difundido en toda América
							y tan bien recibido en toda Europa desde principios de la
							transculturización. El ají, cuando se consume en concentraciones
							adecuadas produce una sensación urente muy estimulante del
